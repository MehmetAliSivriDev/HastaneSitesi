...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='HastaneRandevu.css'>
...
<?php ob_start(); session_start();?>
  <div class="preloader"></div>
    ...
    <nav class="navbar navbar-expand-sm bg-danger navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" style="color: white;">Hastanelerimiz</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container-fluid resim"></div>
    
        
    <div class="container">
        <div class="card" >
            <div class="card-body" >
              <h1 style="text-align: center;" >Hasta İşlemleri</h1>
              <br>
              <h4>Hasta İşlemleri bölümünde gerçekleştirebileceğiniz işlemler;</h4><br>
              <ul>
                <li>
                  
                  <p>Uzman hekimlerimize sormuş olduğunuz soruların cevaplarını doktorlarımız cevap verdiğinde yukarıdaki kullanıcı bölmesinden mesajlar kısmına tıklayarak öğrenebilirsiniz. </p>
                  <p>Hesap ek bilgilerini güncelleme işlemli de yukarıdaki kullanıcı bölmesinden hesap ek bilgileri güncelle kısmında diğer sayfaya giderek bilgilerini tekrardan güncelleyebilirsiniz.</p>
                  <p>Kullanıcıdan çıkış yapmak istiyorsanız yukarıdan kullanıcı kısmından çıkışa tıklayarak ana sayfaya geri gelebilirsiniz.</p>
                  <p>Online randevu almak istiyorsanız online randevu alma butonuna tıklayarak işleminizi kolaylıkla yapabilirsiniz.</p>
                </li>
              </ul>
            
            <ul class="randevuButton">
              <li class="nav-item">
                <a class="nav-link" href="../HastaneRandevu/randevu_kismi/E-Randevu.php" style="color: white;">Online Randevu Alma</a>
              </li>
            </ul>
