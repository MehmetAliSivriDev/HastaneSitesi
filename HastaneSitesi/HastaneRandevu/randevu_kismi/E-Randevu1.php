...
<head>
    ...
    <title>Online Randevu1</title>
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <link rel='stylesheet' type='text/css' media='screen' href='E-Randevu1.css'>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 ">
                        <div class="appoinment-content">
                            <img src="../../social_media_icons/img-3.jpg" alt="" class="img-fluid">
                            <div class="emergency">
                            <h2 class="text-lg"><i class="icofont-phone-circle text-lg"></i>0850 850 8580</h2>
                            </div>
                        </div>
                    </div>
...
<script src = "HastaneRandevu.js"></script>
    ...
    <script>
        ...
        function ValidatePoliklinik(){
            if(form.poliForm.value == 0)
            {
                document.getElementById("poliError").innerHTML = "Lütfen Bir Poliklinik Seçin...";
                
                poliError = true;
            }
            else
            {
                document.getElementById("poliError").innerHTML = "";
                poliError = false;
            }
        }

                
        function ValidateDoktor(){

            if(form.dokForm.value == 0)
            {
                document.getElementById("dokError").innerHTML = "Lütfen Bir Doktor Seçin...";
                dokError = true;

            }
            else
            {
                document.getElementById("dokError").innerHTML = "";
                dokError = false;
            }
            }
    ...
    function doktorGoster()
    {
      ...
      var selectPoli = document.getElementById('poliklinikId');
      var selectPoli_value = selectPoli.options[selectPoli.selectedIndex].value;
      var selectPoli_text = selectPoli.options[selectPoli.selectedIndex].text;

      var selectDok = document.getElementById('doktorlarId');

      if (selectPoli_value == 0)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
      }
      else if (selectPoli_value == 1)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Veysel Uğurlu","1"));
      }
      else if (selectPoli_value == 2)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Ersin Tekinel","1"));
      }
      else if (selectPoli_value == 3)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Dilara Kaya","1"));
      }
      else if (selectPoli_value == 4)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Kaan Yılmaz","1"));
      }
      else if (selectPoli_value == 5)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Ayşe Yılmaz","1"));
      }
      else if (selectPoli_value == 6)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Ayşe Demir","1"));
      }
      else if (selectPoli_value == 7)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Ömer Biçer","1"));
      }
      else if (selectPoli_value == 8)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Emre Bağrıyanık","1"));
      }
      else if (selectPoli_value == 9)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Selin Öztürk","1"));
      }
      else if (selectPoli_value == 10)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Melek Güler","1"));
      }
      else if (selectPoli_value == 11)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Mehmet Ali Uğurlu","1"));
      }
      else if (selectPoli_value == 12)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Kerem Aktürkoğlu","1"));
      }
      else if (selectPoli_value == 13)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Gamze Memiş","1"));
      }
      else if (selectPoli_value == 14)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Duygu Türker","1"));
      }
      else if (selectPoli_value == 15)
      {
        selectDok.replaceChildren();
        selectDok.appendChild(new Option("Doktorlar Seçin","0"));
        selectDok.appendChild(new Option("Dr. Mehmet Ali Sivri","1"));
      }
